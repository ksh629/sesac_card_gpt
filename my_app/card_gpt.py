...
from card_rag import search_card # 우리가 만든 card_rag.py의 함수!
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        {"role": "assistant", "content": "안녕하세요. 저는 카드 추천 AI assistant입니다."} # 화면 출력용. 필요 없으면 이 줄은 없애도 됨
    ]
...
발생 에러: {e}
"""
            st.error(error_) #똑같은 변수 있을 떄 _ 넣어서 헷갈리지 않게
